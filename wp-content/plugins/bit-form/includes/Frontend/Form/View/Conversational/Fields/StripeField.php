...
ADDRESS;
    ...
    return <<<STRIPEFIELD
      <div class="{$fieldHelpers->getConversationalCls('stripe-wrp')}">
      <button type="button" class="{$fieldHelpers->getConversationalCls('stripe-btn')}">
      <svg xmlns="http://www.w3.org/2000/svg" class="{$fieldHelpers->getConversationalCls('stripe-icn')}" viewBox="0 0 24 24">
      ...
      $linkAuthentication
      $address
      <div class="{$fieldHelpers->getConversationalCls('stripe-fld')} d-none"></div>
      </div>
STRIPEFIELD;
  }
}
